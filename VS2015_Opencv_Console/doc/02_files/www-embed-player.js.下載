...
c.prototype=b.prototype;a.M=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Ml=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Tb={};function Ub(a,b,c){this.h=c===Tb?a:"";this.i=b;this.S=this.xa=!0}
Ub.prototype.sa=function(){return this.i};
Ub.prototype.R=function(){return this.h.toString()};
Ub.prototype.toString=function(){return this.h.toString()};
function Vb(a,b){var c=pb();a=c?c.createHTML(a):a;return new Ub(a,b,Tb)}
;function Wb(a,b){b instanceof Hb||b instanceof Hb||(b="object"==typeof b&&b.S?b.R():String(b),Mb.test(b)||(b="about:invalid#zClosurez"),b=new Hb(b,Ib));a.href=Jb(b)}
...
var Mc=new Lc("about:invalid#zTSz",Jc);function Nc(a){if(a instanceof Kc)if(a instanceof Lc)a=a.h;else throw Error("wrong type");else a=Jb(a);return a}
...
function Sc(a,b){db(b,function(c,d){c&&"object"==typeof c&&c.S&&(c=c.R());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Tc.hasOwnProperty(d)?a.setAttribute(Tc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
m=nd.prototype;m.isEnabled=function(){if(!y.navigator.cookieEnabled)return!1;if(!this.isEmpty())return!0;this.set("TESTCOOKIESENABLED","1",{za:60});if("1"!==this.get("TESTCOOKIESENABLED"))return!1;this.remove("TESTCOOKIESENABLED");return!0};
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Tl;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.za}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
$d.prototype.K=function(){return this};function ae(a){if(a instanceof be||a instanceof ce||a instanceof de)return a;if("function"==typeof a.next)return new be(function(){return ee(a)});
if("function"==typeof a[Symbol.iterator])return new be(function(){return a[Symbol.iterator]()});
if("function"==typeof a.K)return new be(function(){return ee(a.K())});
...
be.prototype.K=function(){return new ce(this.j())};
...
m.keys=function(){return ae(this.K(!0)).i()};
m.values=function(){return ae(this.K(!1)).i()};
m.entries=function(){var a=this;return Kd(this.keys(),function(b){return[b,a.get(b)]})};
m.K=function(a){he(this);var b=0,c=this.V,d=this,e=new $d;e.h=function(){if(c!=d.V)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw Zd;var f=d.h[b++];return a?f:d.i[f]};
...
this.i=a;a.defaultPrevented&&me.M.preventDefault.call(this)};
me.prototype.stopPropagation=function(){me.M.stopPropagation.call(this);this.i.stopPropagation?this.i.stopPropagation():this.i.cancelBubble=!0};
me.prototype.preventDefault=function(){me.M.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var oe="closure_listenable_"+(1E6*Math.random()|0);var pe=0;function qe(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.ka=e;this.key=++pe;this.ea=this.ha=!1}
function re(a){a.ea=!0;a.listener=null;a.h=null;a.src=null;a.ka=null}
...
function te(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.ea&&f.listener==b&&f.capture==!!c&&f.ka==d)return e}return-1}
;var ve="closure_lm_"+(1E6*Math.random()|0),we={},xe=0;function ye(a,b,c,d,e){if(d&&d.once)ze(a,b,c,d,e);else if(Array.isArray(b))for(var f=0;f<b.length;f++)ye(a,b[f],c,d,e);else c=Ae(c),a&&a[oe]?a.ca(b,c,Ja(d)?!!d.capture:!!d,e):Be(a,b,c,!1,d,e)}
function Be(a,b,c,d,e,f){if(!b)throw Error("Invalid event type");var g=Ja(e)?!!e.capture:!!e,h=Ce(a);h||(a[ve]=h=new se(a));c=h.add(b,c,d,g,f);if(!c.h){d=De();c.h=d;d.src=a;d.listener=c;if(a.addEventListener)le||(e=g),void 0===e&&(e=!1),a.addEventListener(b.toString(),d,e);else if(a.attachEvent)a.attachEvent(Ee(b.toString()),d);else if(a.addListener&&a.removeListener)a.addListener(d);else throw Error("addEventListener and attachEvent are unavailable.");xe++}}
function De(){function a(c){return b.call(a.src,a.listener,c)}
var b=Fe;return a}
function ze(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)ze(a,b[f],c,d,e);else c=Ae(c),a&&a[oe]?a.i.add(String(b),c,!0,Ja(d)?!!d.capture:!!d,e):Be(a,b,c,!0,d,e)}
function Ge(a,b,c,d,e){if(Array.isArray(b))for(var f=0;f<b.length;f++)Ge(a,b[f],c,d,e);else(d=Ja(d)?!!d.capture:!!d,c=Ae(c),a&&a[oe])?a.i.remove(String(b),c,d,e):a&&(a=Ce(a))&&(b=a.listeners[b.toString()],a=-1,b&&(a=te(b,c,d,e)),(c=-1<a?b[a]:null)&&He(c))}
function He(a){if("number"!==typeof a&&a&&!a.ea){var b=a.src;if(b&&b[oe])ue(b.i,a);else{var c=a.type,d=a.h;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(Ee(c),d):b.addListener&&b.removeListener&&b.removeListener(d);xe--;(c=Ce(b))?(ue(c,a),0==c.h&&(c.src=null,b[ve]=null)):re(a)}}}
function Ee(a){return a in we?we[a]:we[a]="on"+a}
function Fe(a,b){if(a.ea)a=!0;else{b=new me(b,this);var c=a.listener,d=a.ka||a.src;a.ha&&He(a);a=c.call(d,b)}return a}
...
return a[Ie]}
;function Je(){L.call(this);this.i=new se(this);this.J=this;this.o=null}
...
function Ke(a,b){var c=a.o;if(c){var d=[];for(var e=1;c;c=c.o)d.push(c),++e}a=a.J;c=b.type||b;"string"===typeof b?b=new ke(b,a):b instanceof ke?b.target=b.target||a:(e=b,b=new ke(c,a),nb(b,e));e=!0;if(d)for(var f=d.length-1;!b.j&&0<=f;f--){var g=b.h=d[f];e=Le(g,c,!0,b)&&e}b.j||(g=b.h=a,e=Le(g,c,!0,b)&&e,b.j||(e=Le(g,c,!1,b)&&e));if(d)for(f=0;!b.j&&f<d.length;f++)g=b.h=d[f],e=Le(g,c,!1,b)&&e}
Je.prototype.D=function(){Je.M.D.call(this);if(this.i){var a=this.i,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,re(d[e]);delete a.listeners[c];a.h--}}this.o=null};
Je.prototype.ca=function(a,b,c,d){return this.i.add(String(a),b,!1,c,d)};
function Le(a,b,c,d){b=a.i.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.ea&&g.capture==c){var h=g.listener,k=g.ka||g.src;g.ha&&ue(a.i,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
function nf(a,b,c,d){if(b=a.j[b]){var e=a.i;(b=b.find(function(f){return e[f+1]==c&&e[f+2]==d}))&&a.da(b)}}
...
m.D=function(){M.M.D.call(this);this.clear();this.l.length=0};function pf(a){this.h=a}
...
qf.prototype.set=function(a,b){qf.M.set.call(this,a,sf(b))};
qf.prototype.i=function(a){a=qf.M.get.call(this,a);if(void 0===a||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
C(tf,qf);tf.prototype.set=function(a,b,c){if(b=sf(b)){if(c){if(c<Date.now()){tf.prototype.remove.call(this,a);return}b.expiration=c}b.creation=Date.now()}tf.M.set.call(this,a,b)};
tf.prototype.i=function(a){var b=tf.M.i.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<Date.now()||c&&c>Date.now())tf.prototype.remove.call(this,a);else return b}};function uf(){}
;function vf(){}
C(vf,uf);vf.prototype[Symbol.iterator]=function(){return ae(this.K(!0)).i()};
...
m.K=function(a){var b=0,c=this.h,d=new $d;d.h=function(){if(b>=c.length)throw Zd;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
...
m.K=function(a){var b=0,c=this.h.XMLDocument.documentElement.attributes,d=new $d;d.h=function(){if(b>=c.length)throw Zd;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
d.next=d.h.bind(d);return d};
...
Df.prototype.K=function(a){var b=this.i.K(!0),c=this,d=new $d;d.h=function(){for(var e=b.h();e.substr(0,c.h.length)!=c.h;)e=b.h();return a?e.substr(c.h.length):c.i.get(e)};
...
;function eg(a){this.C=a;this.i=null;this.m=0;this.A=null;this.o=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.J=$f(window,"mousemove",Pa(this.N,this));a=Pa(this.G,this);"function"===typeof a&&(a=Lf(a));this.O=window.setInterval(a,25)}
C(eg,L);eg.prototype.N=function(a){void 0===a.h&&Wf(a);var b=a.h;void 0===a.i&&Wf(a);this.i=new Pc(b,a.i)};
eg.prototype.G=function(){if(this.i){var a=bg();if(0!=this.m){var b=this.A,c=this.i,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.m);this.j[this.l]=.5<Math.abs((d-this.o)/this.o)?1:0;for(c=b=0;4>c;c++)b+=this.j[c]||0;3<=b&&this.C();this.o=d}this.m=a;this.A=this.i;this.l=(this.l+1)%4}};
eg.prototype.D=function(){window.clearInterval(this.O);ag(this.J)};function fg(){}
...
;function Dg(a){var b=Eg;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=gd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(Ia){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?K:g;try{var h=g.history.length}catch(Ia){h=0}e.u_his=h;e.u_java=!!K.navigator&&"unknown"!==typeof K.navigator.javaEnabled&&!!K.navigator.javaEnabled&&K.navigator.javaEnabled();K.screen&&(e.u_h=K.screen.height,e.u_w=K.screen.width,
...
return e}
function Ug(a){if(Ja(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;sb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");var d=Vb(a[b],null);a[c]=d}else Ug(a[b])}}
...
;var Xg={},Yg=0;
function Zg(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!Wg("cobalt")){if(a){a instanceof Hb||(a="object"==typeof a&&a.S?a.R():String(a),Mb.test(a)?a=new Hb(a,Ib):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Lb))&&Kb.test(b[1])?new Hb(a,Ib):null));b=Jb(a||Nb);if("about:invalid#zClosurez"===b||b.startsWith("data"))a="";else{if(b instanceof Ub)a=b;else{var f="object"==typeof b;a=null;f&&b.xa&&(a=b.sa());b=f&&b.S?b.R():String(b);Gb.test(b)&&(-1!=b.indexOf("&")&&(b=b.replace(Ab,"&amp;")),-1!=b.indexOf("<")&&
...
function yh(a,b){if("log_event"===a.endpoint){var c="";a.ja?c="visitorOnlyApprovedKey":a.F&&(xh[a.F.token]=zh(a.F),c=a.F.token);var d=wh.get(c)||[];wh.set(c,d);d.push(a.payload);b&&(rh=new b);a=Rf("tvhtml5_logging_max_batch")||Rf("web_logging_max_batch")||100;b=P();d.length>=a?Ah({writeThenSend:!0},O("flush_only_full_queue")?c:void 0):10<=b-uh&&(Bh(),uh=b)}}
function Ch(a,b){if("log_event"===a.endpoint){var c="";a.ja?c="visitorOnlyApprovedKey":a.F&&(xh[a.F.token]=zh(a.F),c=a.F.token);var d=new Map;d.set(c,[a.payload]);b&&(rh=new b);return new Ve(function(e){rh&&rh.isReady()?Dh(d,e,{bypassNetworkless:!0}):e()})}}
...
;var Jh=y.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",Jh,void 0);function Kh(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=pg();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};O("log_sequence_info_on_gel_web")&&d.U&&(a=e.context,b=d.U,Jh[b]=b in Jh?Jh[b]+1:0,a.sequence={index:Jh[b],groupKey:b},d.Va&&delete Jh[d.U]);(d.Ul?Ch:yh)({endpoint:"log_event",payload:e,F:d.F,ja:d.ja},c)}
...
;function Mh(a,b,c,d,e){od.set(""+a,b,{za:c,path:"/",domain:void 0===d?"youtube.com":d,secure:void 0===e?!1:e})}
...
d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});f=b.client.clientName;if("WEB"===f||"MWEB"===f||1===f||2===f){if(!O("web_include_display_mode_killswitch")){var g;b.client.mainAppWebInfo=null!=(g=b.client.mainAppWebInfo)?g:{};b.client.mainAppWebInfo.webDisplayMode=Lh()}}else if(g=b.client.clientName,("WEB_REMIX"===g||76===g)&&!O("music_web_display_mode_killswitch")){var h;b.client.Ka=null!=(h=b.client.Ka)?h:{};b.client.Ka.webDisplayMode=Lh()}a.appInstallData&&
...
function R(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?Di[a]:c;d=void 0===d?Fi[a]:d;e=void 0===e?Hi[a]:e;xi.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,R.prototype)}
v(R,xi);function Ii(a){R.call(this,"MISSING_OBJECT_STORE",{gb:a},Di.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Ii.prototype)}
v(Ii,R);function Ji(a,b){var c=Error.call(this);this.message=c.message;"stack"in c&&(this.stack=c.stack);this.index=a;this.objectStore=b;Object.setPrototypeOf(this,Ji.prototype)}
...
function Li(a,b,c,d){b=Bi(b);var e=a instanceof Error?a:Error("Unexpected error: "+a);if(e instanceof R)return e;if("QuotaExceededError"===e.name)return new R("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(Bc&&"UnknownError"===e.name)return new R("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if(e instanceof Ji)return new R("MISSING_INDEX",{dbName:b,dbVersion:d,objectStore:e.objectStore,index:e.index});if("InvalidStateError"===e.name&&Ki.some(function(f){return e.message.includes(f)}))return new R("EXECUTE_TRANSACTION_ON_CLOSED_DB",
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",Ql:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
function Mi(a,b,c){return new R("IDB_NOT_SUPPORTED",{context:{caller:a,publicName:b,version:c}})}
...
S.all=function(a){return new S(new Pi(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={Z:0};f.Z<a.length;f={Z:f.Z},++f.Z)Qi(S.resolve(a[f.Z]).then(function(g){return function(h){d[g.Z]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
...
m=Yi.prototype;m.add=function(a,b,c){return Zi(this,[a],{mode:"readwrite",I:!0},function(d){return d.objectStore(a).add(b,c)})};
m.clear=function(a){return Zi(this,[a],{mode:"readwrite",I:!0},function(b){return b.objectStore(a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return Zi(this,[a],{mode:"readonly",I:!0},function(c){return c.objectStore(a).count(b)})};
function $i(a,b,c){a=a.h.createObjectStore(b,c);return new aj(a)}
m.delete=function(a,b){return Zi(this,[a],{mode:"readwrite",I:!0},function(c){return c.objectStore(a).delete(b)})};
m.get=function(a,b){return Zi(this,[a],{mode:"readonly",I:!0},function(c){return c.objectStore(a).get(b)})};
function bj(a,b){return Zi(a,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(c){c=c.objectStore("LogsRequestsStore");return Wi(c.h.put(b,void 0))})}
...
Q=Li(I,g.h.name,b.join(),g.h.version);if((V=Q instanceof R&&!Q.h)||l>=k)ej(g,q,E,l,Q,b.join(),h),n=Q;J.B(2);break;case 3:return J.return(Promise.reject(n))}})})}
function ej(a,b,c,d,e,f,g){b=c-b;e?(e instanceof R&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&wi("QUOTA_EXCEEDED",{dbName:Bi(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof R&&"UNKNOWN_ABORT"===e.type&&(c-=a.j,0>c&&c>=Math.pow(2,31)&&(c=0),wi("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c}),a.i=!0),fj(a,!1,d,f,b,g.tag),vi(e)):fj(a,!0,d,f,b,g.tag)}
...
h.delete(),7);case 7:return vi(new R("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,gb:l})),p.return(a());case 6:throw new Ii(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.B(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,vb:b,upgrade:this.options.upgrade};return this.h=d=a()};var rj=new pj("YtIdbMeta",{la:{databases:{ra:1}},upgrade:function(a,b){b(1)&&$i(a,"databases",{keyPath:"actualName"})}});
function sj(a){return H(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,rj.open(),2);d=e.i;return e.return(Zi(d,["databases"],{I:!0,mode:"readwrite"},function(f){var g=f.objectStore("databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier:1)return Wi(g.h.put(a,void 0)).then(function(){})})}))})})}
...
function uj(a){return H(this,function c(){var d,e;return x(c,function(f){return 1==f.h?(d=[],w(f,rj.open(),2)):3!=f.h?(e=f.i,w(f,Zi(e,["databases"],{I:!0,mode:"readonly"},function(g){d.length=0;return hj(g.objectStore("databases"),{},function(h){a(h.getValue())&&d.push(h.getValue());return h.continue()})}),3)):f.return(d)})})}
...
;new function(){var a=this;this.promise=new Promise(function(b,c){a.resolve=b;a.reject=c})};function Bj(a){if(!yi())throw a=new R("AUTH_INVALID",{dbName:a}),vi(a),a;var b=zi();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
...
function Rj(a){return H(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,Nj().open(),2);d=e.i;return e.return(Zi(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",Wi(g.h.put(h,void 0)).then(function(){return h})})}))})})}
function Sj(a){return H(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,Nj().open(),2);d=e.i;return e.return(Zi(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,Wi(g.h.put(h,void 0)).then(function(){return h})):S.resolve(void 0)})}))})})}
...
;var Wj={},Xj=Lj("ServiceWorkerLogsDatabase",{la:(Wj.SWHealthLog={ra:1},Wj),Ba:!0,upgrade:function(a,b){b(1)&&$i(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function Yj(){return H(this,function b(){var c,d;return x(b,function(e){if(1==e.h)return O("web_clean_sw_logs_store")?w(e,Xj().open(),3):e.B(0);c=e.i;d=P()-2592E6;return w(e,Zi(c,["SWHealthLog"],{mode:"readwrite",I:!0},function(f){return hj(f.objectStore("SWHealthLog"),{},function(g){if(g.getValue().timestamp<=d)return g.delete().then(function(){return g.continue()})})}),0)})})}
...
;var dk=Rf("network_polling_interval",3E4);function T(){Je.call(this);this.C=0;this.G=this.l=!1;this.j=this.wa();ek(this);fk(this)}
...
function fk(a){window.addEventListener("online",function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.Y(),2);if(d.G&&O("offline_error_handling")){var f=bk().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new xi(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Mf(h)}bk().set("errors",{},2592E3,!0)}}e.h=0})})})}
...
function hk(a){a.C=gg(function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.j?d.wa()||!d.l?e.B(3):w(e,d.Y(),3):w(e,d.Y(),3);hk(d);e.h=0})})},dk)}
...
T.prototype.sendNetworkCheckRequest=T.prototype.Y;T.prototype.listen=T.prototype.ca;T.prototype.enableErrorFlushing=T.prototype.Sa;T.prototype.getWindowStatus=T.prototype.wa;T.prototype.monitorNetworkStatusChange=T.prototype.hb;T.prototype.isNetworkAvailable=T.prototype.L;T.getInstance=gk;function ik(a){a=void 0===a?{}:a;Je.call(this);var b=this;this.l=this.A=0;this.j=gk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Ta);a.fb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.na?(this.na=a.na,c("ytnetworkstatus-online",function(){jk(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){jk(b,"publicytnetworkstatus-offline")})):
...
v(ik,Je);ik.prototype.L=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.j);return a?a():!0};
...
function jk(a,b){a.na?a.l?(kg(a.A),a.A=ig(function(){a.m!==b&&(Ke(a,b),a.m=b,a.l=P())},a.na-(P()-a.l))):(Ke(a,b),a.m=b,a.l=P()):Ke(a,b)}
...
yk(e.url,e.options);Oj(e).then(function(h){e.id=h;f&&Tj(e.id)}).catch(function(h){sk().L()?Mf(h):ck(h)})}else yk(a,b)}
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?Aj().then(function(d){c(d)}):c(Ak())}
...
function rk(){var a=this;if(!Ak())throw Mi("retryQueuedRequests");Qj("QUEUED").then(function(b){b&&!Ck(b,12E4)?ig(function(){return H(a,function d(){return x(d,function(e){if(1==e.h)return void 0===b.id?e.B(2):w(e,Sj(b.id),2);rk();e.h=0})})}):sk().L()&&tk()})}
...
function Ih(a,b,c,d){function e(r){r=void 0===r?!1:r;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(r||(p=ai(b,c,l,k)),p)){var z=g.onSuccess,I=g.onFetchSuccess;g.onSuccess=function(E,Q){bi(p);z(E,Q)};
c.onFetchSuccess=function(E,Q){bi(p);I(E,Q)}}try{r&&d.retry&&!d.La.bypassNetworkless?(g.method="POST",d.La.writeThenSend?wk(q,g):Bk(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Ng(q,g))}catch(E){if("InvalidAccessError"==E.name)p&&(bi(p),p=0),Nf(Error("An extension is blocking network request."));
...
ma:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Ik={T:[],P:[{Ea:Hk,weight:500}]};function Hk(a){a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
Lk();c=u(a.T);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Pl)){a=d.weight;break a}a=u(a.P);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ea(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Gk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.ma[l.name])for(e=u(c.ma[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
d=u(d);for(e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(gb(e)||!e.trackingParams&&!e.veType)&&Yk(Error("Child VE logged with no data"));d={F:Fl(b),U:b};"UNDEFINED_CSN"==b?Nl("visualElementAttached",c,d):a?Kh("visualElementAttached",c,a,d):Fk("visualElementAttached",c,d)}
...
;function sn(a,b,c){L.call(this);var d=this;c=c||F("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.C="*";this.l=c;this.sessionId=null;this.channel="widget";this.G=!!a;this.A=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.G&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
m=tn.prototype;m.lb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,un(this,a)),this.j[a]=!0)):this.Ca(a,b,c)};
m.Ca=function(){};
...
function yn(a,b,c,d){if(Ja(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
...
m.Ca=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&wn(a)){var d=b;if(Ja(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=xn(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=xn(e);break;case "loadPlaylist":case "cuePlaylist":e=yn(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);wn(a)&&vn(this,this.va())}};
...
Dn.prototype.ta=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return An.prototype.ta.call(this,a,b)};
...
v(Hn,L);Hn.prototype.D=function(){for(;this.i.length;){var a=this.i.pop();a.target.removeEventListener(a.name,a.Ea,void 0)}L.prototype.D.call(this)};function In(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||kb(b);this.assets=a.assets||{};this.attrs=a.attrs||kb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
...
;function On(a,b,c,d){L.call(this);var e=this;this.G=b;this.webPlayerContextConfig=d;this.oa=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.O=this.fa=this.elementId=this.qa=this.config=null;this.N=!1;this.l=this.A=null;this.ga={};this.Oa=["onReady"];this.lastError=null;this.Da=NaN;this.C={};this.Pa=new Hn(this);this.aa=0;this.j=this.o=a;Ud(this,Qa(Sd,this.J));Pn(this);Qn(this);Ud(this,Qa(Sd,this.Pa));c?this.aa=cg(function(){e.loadNewVideoConfig(c)},0):d&&(Rn(this),Sn(this))}
v(On,L);m=On.prototype;m.getId=function(){return this.G};
m.loadNewVideoConfig=function(a){if(!this.h){this.aa&&(dg(this.aa),this.aa=0);var b=a||{};b instanceof In||(b=new In(b));this.config=b;this.setConfig(a);Sn(this);this.isReady()&&Tn(this)}};
function Rn(a){var b,c;a.webPlayerContextConfig?c=a.webPlayerContextConfig.rootElementId:c=a.config.attrs.id;a.elementId=c||a.elementId;"video-player"===a.elementId&&(a.elementId=a.G,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.G:a.config.attrs.id=a.G);(null===(b=a.j)||void 0===b?void 0:b.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
m.setConfig=function(a){var b;this.qa=a;this.config=Un(a);Rn(this);this.fa||(this.fa=Vn(this,(null===(b=this.config.args)||void 0===b?void 0:b.jsapicallback)||"onYouTubePlayerReady"));this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null===(c=this.config)||void 0===c?0:c.attrs)a=this.config.attrs,(c=a.width)&&this.j&&(this.j.style.width=fd(Number(c)||c)),(a=a.height)&&this.j&&(this.j.style.height=fd(Number(a)||a))};
...
function Sn(a){if(!a.h&&!a.N){var b=Wn(a);if(b&&"html5"===(Xn(a)?"html5":null))a.O="html5",a.isReady()||Zn(a);else if($n(a),a.O="html5",b&&a.l&&a.o)a.o.appendChild(a.l),Zn(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.A=function(){c=!0;var d=ao(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Un(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);Zn(a)};
a.N=!0;b?a.A():(Um(Yn(a),a.A),(b=bo(a))&&Kn(b),co(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
function Xn(a){var b=Rc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function Zn(a){var b;if(!a.h){var c=Xn(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.N=!1,!ao(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||eo(a)):a.Da=cg(function(){Zn(a)},50)}}
function eo(a){Pn(a);a.oa=!0;var b=Xn(a);if(b){a.m=fo(a,b,"addEventListener");a.ba=fo(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=fo(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.m&&a.m(g,a.i[g]);Tn(a);a.fa&&a.fa(a.api);a.J.W("onReady",a.api)}
...
function Pn(a){a.oa=!1;if(a.ba)for(var b in a.i)a.i.hasOwnProperty(b)&&a.ba(b,a.i[b]);for(var c in a.C)a.C.hasOwnProperty(c)&&dg(Number(c));a.C={};a.m=null;a.ba=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
m.addEventListener=function(a,b){var c=this,d=Vn(this,b);d&&(0<=Wa(this.Oa,a)||this.i[a]||(b=go(this,a),this.m&&this.m(a,b)),this.J.subscribe(a,d),"onReady"===a&&this.isReady()&&cg(function(){d(c.api)},0))};
m.removeEventListener=function(a,b){this.h||(b=Vn(this,b))&&nf(this.J,a,b)};
function Vn(a,b){var c=b;if("string"===typeof b){if(a.ga[b])return a.ga[b];c=function(d){for(var e=[],f=0;f<arguments.length;++f)e[f-0]=arguments[f];if(f=B(b))try{f.apply(y,e)}catch(g){Zk(g)}};
a.ga[b]=c}return c?c:null}
function go(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;y[c]=function(d){var e=cg(function(){if(!a.h){a.J.W(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
hb(a.C,String(e))};
return c}
m.getPlayerType=function(){return this.O||(Xn(this)?"html5":null)};
m.getLastError=function(){return this.lastError};
function $n(a){a.cancel();Pn(a);a.O=null;a.config&&(a.config.loaded=!1);var b=Xn(a);b&&(Wn(a)||!co(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&$m(Yn(this),this.A);dg(this.Da);this.N=!1};
m.D=function(){$n(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){Zk(b)}this.ga=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.qa=this.config=this.api=null;delete this.o;delete this.j;L.prototype.D.call(this)};
...
d.secureConnectionStart&&(Z("nstcps",d.secureConnectionStart,void 0),Z("ntcpe",d.connectEnd,void 0));W&&W.getEntriesByType&&Hm();d=[];if(document.querySelector&&W&&W.getEntriesByName)for(var f in am)am.hasOwnProperty(f)&&(c=am[f],Gm(f,c)&&d.push(c));for(f=0;f<d.length;f++)Cm("rc",d[f]);if(xm(void 0)){f={actionType:rm[F("TIMING_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN",previousAction:rm[F("PREVIOUS_ACTION",void 0)]||"LATENCY_ACTION_UNKNOWN"};if(d=Dl())f.clientScreenNonce=d;d=im(void 0);pm().info(f,
d)}f=hm();c=cm();if("cold"===f.yt_lt&&(d=zm(),e=d.gelTicks?d.gelTicks:d.gelTicks={},d=d.gelInfos?d.gelInfos:d.gelInfos={},xm())){for(var g in c)"tick_"+g in e||ym(g,c[g]);g=Bm();c=im();e={};var h=!1,k;for(k in f)if(!("info_"+k in d)){var l=Am(k,f[k]);l&&(Pl(g,l),Pl(e,l),h=!0)}h&&pm().info(e,c)}A("ytglobal.timingready_",!0,void 0);Dm();(k=F("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in k?(k=k.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,k.serializedForcedExperimentIds||
(g=Ag(),g.forced_experiments&&(k.serializedForcedExperimentIds=g.forced_experiments)),lo=jo(a,k,!1)):lo=jo(a);lo.addEventListener("onVideoDataChange",oo);a=F("POST_MESSAGE_ID","player");F("ENABLE_JS_API")?no=new zn(lo):F("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(mo=new Gn(window.parent,a,b),no=new Dn(lo,mo.connection));cn();O("networkless_logging_web_embedded")&&qk();O("embeds_enable_ua_ch_polyfill")&&rn()},void 0);
